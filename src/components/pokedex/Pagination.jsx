export const Pagination = ({ lastPage, pagesInCurrentBlock, setCurrentPage, currentPage }) => {
    ...
    <ul className="flex justify-center gap-4 p-4 items-center">
      ...
      {pagesInCurrentBlock.map((page) => (
        <li className={`p-4 ${currentPage === page ? "text-white bg-red-500" : ""}`} key={page} onClick={() => setCurrentPage(page)}>{page}</li>
      ))}
